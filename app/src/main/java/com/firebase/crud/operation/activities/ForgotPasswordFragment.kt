...
import com.firebase.crud.operation.viewmodels.ForgotPasswordViewModel
import com.firebase.crud.operations.R
import com.firebase.crud.operations.databinding.FragmentForgotPasswordBinding
...
class ForgotPasswordFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        viewModel.isForgetPass.observe(viewLifecycleOwner, {
            if (it) {
